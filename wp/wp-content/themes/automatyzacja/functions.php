...
class StarterSite extends TimberSite {
	...
	public function register_post_types() {
		register_post_type( 'portolio', array(
			'labels'            => array(
				'name'                => __( 'Portfolios', 'automatyzacja' ),
				'singular_name'       => __( 'Portfolio', 'automatyzacja' ),
				'all_items'           => __( 'All Portfolios', 'automatyzacja' ),
				'new_item'            => __( 'New Portfolio', 'automatyzacja' ),
				'add_new'             => __( 'Add New', 'automatyzacja' ),
				'add_new_item'        => __( 'Add New Portfolio', 'automatyzacja' ),
				'edit_item'           => __( 'Edit Portfolio', 'automatyzacja' ),
				'view_item'           => __( 'View Portfolio', 'automatyzacja' ),
				'search_items'        => __( 'Search Portfolios', 'automatyzacja' ),
				'not_found'           => __( 'No Portfolios found', 'automatyzacja' ),
				'not_found_in_trash'  => __( 'No Portfolios found in trash', 'automatyzacja' ),
				'parent_item_colon'   => __( 'Parent Portfolio', 'automatyzacja' ),
				'menu_name'           => __( 'Portfolios', 'automatyzacja' ),
			),
			'public'            => true,
			'hierarchical'      => false,
			'show_ui'           => true,
